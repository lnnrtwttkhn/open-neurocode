...
The papers listed below have a least one author who is affiliated with the NeuroCode group.
...
Categories are: `code only`, `data only` and `mixed` (code and data mixed in one repository) or `n/a` (not applicable, i.e., no repository available).
